...
class RitzauFeedParserDetectDuplicates(BaseRitzauFeedParser):
    """
    Feed Parser which can parse Ritzau XML feed
    """

    NAME = "bor_ritzau_detect_duplicates"
    label = "Borsen Ritzau feed (detect duplicates)"
...
register_feed_parser(RitzauFeedParserDetectDuplicates.NAME, RitzauFeedParserDetectDuplicates())
