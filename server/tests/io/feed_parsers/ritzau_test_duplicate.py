...
from borsen.io.feed_parsers.ritzau_detect_duplicates import RitzauFeedParserDetectDuplicates as RitzauFeedParser
import borsen
    ...
    def test_duplicate_detection_by_headline_similarity(self):
        ...
        ingest_items = [
            # Matching item — should be selected
            {
                "_id": "existing-id",
                "guid": "original-guid",
                "headline": "Bank of England fastholder helt som ventet renten i 4,25 pct.",
                "body_html": "Original content",
                "_created": datetime.utcnow() - timedelta(hours=1),
